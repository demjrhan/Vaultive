    ...
    public partial class Inital : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AudioOptions", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubtitleOptions", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AudioLanguages_AudioOptions_AudioOptionId",
                        column: x => x.AudioOptionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationInDays = table.Column<double>(type: "REAL", nullable: false),
                    StreamingServiceId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubtitleLanguages_SubtitleOptions_SubtitleOptionId",
                        column: x => x.SubtitleOptionId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AudioLanguages_AudioOptionId",
                table: "AudioLanguages",
                column: "AudioOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_AudioOptions_MediaTitle",
                table: "AudioOptions",
                column: "MediaTitle",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubtitleLanguages_SubtitleOptionId",
                table: "SubtitleLanguages",
                column: "SubtitleOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_SubtitleOptions_MediaTitle",
                table: "SubtitleOptions",
                column: "MediaTitle",
                unique: true);
