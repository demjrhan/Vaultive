...
const recommendations = [
  { id: 'pulpfiction', src: './public/img/pulpfiction-poster.png', alt: 'Pulp Fiction', },
  { id: 'avengers', src: './public/img/avengers-poster.png', alt: 'Avengers' },
...
const details = [
  ...
  },
  {
    ...
    title: 'Pulp Fiction',
    description:
      'Pulp Fiction is a cult classic directed by Quentin Tarantino, weaving multiple crime stories in a non-linear narrative. It features unforgettable characters like Vincent Vega and Jules Winnfield, whose dialogue has become iconic. The film is praised for its unique storytelling, eclectic soundtrack, and dark humor. It’s a landmark in independent cinema and a must-watch for film lovers.',
    background: "url('../public/img/pulpfiction-background.png')",
    backgroundGif: "url('../public/gif/pulpfiction.gif')",
  },
  {
    id: 'avengers',
  ...
  },
  {
    ...
    title: 'God Father',
    description:
      'The Godfather is a cinematic masterpiece that chronicles the rise of Michael Corleone in the powerful Italian-American mafia family. It explores themes of loyalty, power, and family through unforgettable storytelling. The film’s direction, performances, and score are critically acclaimed and deeply influential. It remains one of the greatest and most respected films in history.',
    background: "url('../public/img/godfather-background.png')",
    backgroundGif: "url('../public/gif/godfather.gif')",
  },
  {
    id: 'scarface',
    ...
    alt: 'Scarface',
    title: 'Scarface',
    description: "Scarface follows the rise and fall of Tony Montana, a Cuban immigrant who builds a violent drug empire in 1980s Miami. Fueled by ambition and a hunger for power, Tony's journey is both captivating and tragic. The film is known for its intense performances, iconic quotes, and gritty portrayal of crime and excess. It's a brutal yet unforgettable tale of the American Dream gone wrong.",
